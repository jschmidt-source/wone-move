...
```bash
INIT=$(node "C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
