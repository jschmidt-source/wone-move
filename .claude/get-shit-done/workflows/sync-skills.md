...
INSTALL_JS_GLOBAL="C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
