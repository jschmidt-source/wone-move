...
```
Agent(
  prompt="Read C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/templates/SECURITY.md`
