...
```bash
INIT=$(node "C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/JilSchmidt/Projects/Wone MOVE/.claude/get-shit-done/templates/spec.md.
